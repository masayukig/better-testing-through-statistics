...
%http://cacti.openstack.org/cacti/graph.php?action=view&local_graph_id=717&rra_id=all
    \item \textasciitilde9 TB of data compressed
  \end{itemize}
  \begin{center}
...
\frametitle{Where to get more information}
    \begin{itemize}
        ...
        \item \href{https://docs.openstack.org/infra/system-config/}{https://docs.openstack.org/infra/system-config/}
        \item \href{http://status.openstack.org/openstack-health}{http://status.openstack.org/openstack-health}
        \item \href{http://status.openstack.org/elastic-recheck/}{http://status.openstack.org/elastic-recheck/}
        \item \href{https://github.com/masayukig/better-testing-through-statistics/tree/openwest2017}{https://github.com/masayukig/better-testing-through-statistics/tree/openwest2017}
    \end{itemize}
\end{frame}
